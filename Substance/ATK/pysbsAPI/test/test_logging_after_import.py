...
class LoggingConfigurationAfterTestCase(unittest.TestCase):
    """
    This test case is focusing testing pysbs does not conflicts with Python standard library logging configuration
    This test case is separated from `LoggingConfigurationBeforeTestCase` to avoid side-effect resulting from calling `logging.basicConfig`
    """


    def test_LoggingBasicConfigCalledAfterImport(self):
        """
